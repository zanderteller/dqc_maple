...
*/
DLLEXPORT int BiggestOutlier(double* mat, int num_rows, int num_cols)
{
...
extern "C"
{
	...
	* (none)
	*/
	DLLEXPORT void BuildOverlapsC(double sigma, double* basis_rows, double* other_rows, int num_basis_rows,
